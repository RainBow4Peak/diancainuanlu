...
/**
  * @brief  Enables or disables the Low Speed APB (APB1) peripheral clock. 外设时钟
  * @param  RCC_APB1Periph: specifies the APB1 peripheral to gates its clock. 指定APB1外设来控制其时钟
  *   This parameter can be any combination of the following values:  此参数可以是以下任意值的组合
  ...
  * @param  NewState: new state of the specified peripheral clock. 指定外设时钟的新状态
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
